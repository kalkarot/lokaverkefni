...
def drawWalls(beginPos, endPos):
    pygame.draw.line(DISPLAYSURF, BLACK, beginPos, endPos, 5)
def walls():
...
while True:
   ...
   # for wall in walls:
    #    drawWalls(wall[0],wall[1])
     #   if (x >  wall[0][0] and x > wall[1][0]):
      #      falling = False
       # else:
        #    falling = True
